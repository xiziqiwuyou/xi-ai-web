...
assert(apiConnectionModal.includes("document.body.style.overflow = \"hidden\""), "API modal should lock body scroll");
assert(apiConnectionModal.includes("previousOverflowRef.current"), "API modal should restore previous body overflow");
assert(apiConnectionModal.includes("previousPaddingRightRef.current"), "API modal should restore previous body padding");
