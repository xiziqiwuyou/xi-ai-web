...
export const KNOWLEDGE_ERROR_CODES = Object.freeze({
  ...
  OCR_DISABLED: "KB_OCR_DISABLED",
  OCR_OUTPUT_INVALID: "KB_OCR_OUTPUT_INVALID",
  OCR_PROVIDER_ERROR: "KB_OCR_PROVIDER_ERROR",
  OCR_TIMEOUT: "KB_OCR_TIMEOUT",
  ...
  RETRIEVAL_ENHANCEMENT_CONNECTION_REQUIRED: "KB_RETRIEVAL_ENHANCEMENT_CONNECTION_REQUIRED",
  RETRIEVAL_ENHANCEMENT_DISABLED: "KB_RETRIEVAL_ENHANCEMENT_DISABLED",
  RETRIEVAL_ENHANCEMENT_MODEL_INVALID: "KB_RETRIEVAL_ENHANCEMENT_MODEL_INVALID",
  RETRIEVAL_ENHANCEMENT_OUTPUT_INVALID: "KB_RETRIEVAL_ENHANCEMENT_OUTPUT_INVALID",
  RETRIEVAL_ENHANCEMENT_PROVIDER_ERROR: "KB_RETRIEVAL_ENHANCEMENT_PROVIDER_ERROR",
  RETRIEVAL_ENHANCEMENT_TIMEOUT: "KB_RETRIEVAL_ENHANCEMENT_TIMEOUT",
...
export class KnowledgeError extends Error {
  constructor(code, message, { status = 500, details, cause, retryable } = {}) {
